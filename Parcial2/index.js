  ...
  const App = {
    ...
    handlers: {
      pokemonFinderFormOnSubmit: async (e) => {
        ...
        try {
          ...
          App.htmlElements.pokemonFinderOutput.innerHTML = `<div id="error"><h1 class="cleanSearch">Esta ${searchType} no existe, vuelve a intentarlo</h1><div>`;
        }
      },
      cleanTemplate: (e) => {
        e.preventDefault();
    ...
    templates: {
      ...
      pokemonCard: ({ id, name, weight, height, sprites, abilities }) => {
        ...
        return ` 
                  <div id="hidden" class="card-pokemon">
                  <h1>${name} (${id})</h1>
                    ...
                    <div class="info-sprites">
                      ...
                      <div class="sprites">
                        <img alt="PokéAPI"src="${sprites.back_default}"/>
                        <img  class="sprite-two" alt="PokéAPI"src="${
